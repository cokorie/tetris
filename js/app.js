document.addEventListener('DOMContentLoaded', () => {
    // TODO: can also get grid size from user
    const GRID_WIDTH = 10;
    const GRID_HEIGHT = 20;
    const GRID_SIZE = GRID_WIDTH * GRID_HEIGHT;
  
    // for shorther div count in HTML code
    ...
    function createGrid() {
      ...
      // 16 is max grid size for fit of Tetrominoes, so creating an extra one here as well
      for (let i = 0; i < 16; i++) {
        let gridElement = document.createElement("div");
    ...
    // shows previous tetromino in scoreDisplay section
